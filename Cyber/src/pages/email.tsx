    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Email Authentication Detector - Installation & Usage Guide
          </h2>
          <ol
            style={{
          ...
          >
            {[
              ...
              "Analyze Email Authentication and Customize Settings",
              "Open the email you want to analyze and access the extension from the browser toolbar.",
              "The extension will extract key details, including the sender and *subject, and assign a risk score based on predefined security categories.",
              "It will verify if the sender is authenticated or not.",
              "A settings panel allows users to adjust notification levels based on preferences.",
              "A customization option enables users to define specific keywords for filtering and risk assessment.",
            ].map((step, index) => (
              <motion.li
                key={index}
